...
func (x *GetUserSecretRequest) GetSecret() string {
	if x != nil {
		return x.Secret
	}
	return ""
...
func (x *GetUserSecretRequest) GetId() string {
	if x, ok := x.GetQuery().(*GetUserSecretRequest_Id); ok {
		return x.Id
	}
	return ""
}
...
func (x *GetUserSecretRequest) GetEmail() string {
	if x, ok := x.GetQuery().(*GetUserSecretRequest_Email); ok {
		return x.Email
	}
	return ""
}

type isGetUserSecretRequest_Query interface {
	isGetUserSecretRequest_Query()
}
...
func (*GetUserSecretRequest_Id) isGetUserSecretRequest_Query() {}

func (*GetUserSecretRequest_Email) isGetUserSecretRequest_Query() {}
...
var file_user_service_proto_rawDesc = []byte{
	...
	0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x2e, 0x0a, 0x11, 0x43, 0x72,
	...
	0x22, 0x2e, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65,
	...
	0x65, 0x22, 0x61, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x63, 0x72,
	0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x65, 0x63,
	...
	0x02, 0x69, 0x64, 0x12, 0x16, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x48, 0x00, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x42, 0x07, 0x0a, 0x05, 0x71,
	0x75, 0x65, 0x72, 0x79, 0x22, 0x32, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x53,
	0x65, 0x63, 0x72, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x19, 0x0a,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0x2c, 0x0a, 0x0f, 0x47,
	...
	0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70,
	0x74, 0x79, 0x32, 0xc0, 0x02, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x33, 0x0a, 0x06, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x12, 0x2e, 0x43,
...
var file_user_service_proto_goTypes = []interface{}{
	...
	(*GetUserSecretRequest)(nil),  // 7: GetUserSecretRequest
	(*GetUserSecretResponse)(nil), // 8: GetUserSecretResponse
...
var file_user_service_proto_depIdxs = []int32{
	13, // 0: User.created_at:type_name -> google.protobuf.Timestamp
	13, // 1: User.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 2: CreateUserRequest.user:type_name -> User
	0,  // 3: UpdateUserRequest.user:type_name -> User
	0,  // 4: GetUserSecretResponse.user:type_name -> User
	0,  // 5: GetUserResponse.user:type_name -> User
	1,  // 6: UserService.Create:input_type -> CreateUserRequest
	3,  // 7: UserService.Update:input_type -> UpdateUserRequest
	5,  // 8: UserService.Delete:input_type -> DeleteUserRequest
	9,  // 9: UserService.Get:input_type -> GetUserRequest
	7,  // 10: UserService.GetSecret:input_type -> GetUserSecretRequest
	10, // 11: UserService.GetStream:input_type -> GetUsersRequest
	2,  // 12: UserService.Create:output_type -> CreateUserResponse
	4,  // 13: UserService.Update:output_type -> UpdateUserResponse
	6,  // 14: UserService.Delete:output_type -> DeleteUserResponse
	11, // 15: UserService.Get:output_type -> GetUserResponse
	8,  // 16: UserService.GetSecret:output_type -> GetUserSecretResponse
...
func file_user_service_proto_init() {
	...
	file_user_service_proto_msgTypes[7].OneofWrappers = []interface{}{
		(*GetUserSecretRequest_Id)(nil),
		(*GetUserSecretRequest_Email)(nil),
	}
	type x struct{}
